...
var DEFAULT_URL = window.parent._PDFSource; //'compressed.tracemonkey-pldi-09.pdf';
...
var USER_LANGUAGE = window.parent.application.USER_DATA.userLanguage;
...
function webViewerInitialized() {
  ...
  var locale = USER_LANGUAGE ||  PDFJS.locale || navigator.language;
